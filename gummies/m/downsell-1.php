...
<div class="container"> 
	<div class="top-red-strip">
        <p><span>FREE BONUS BOTTLES UNLOCKED</span> - DO NOT CLOSE THIS WINDOW!</p>
    </div>
    <div class="clearall"></div>

	<div class="up-top-hdng">
        <p class="hdng-txt1"><span>Fair Enough.. <br>But We Are Not Giving Up Yet!</span></p>
        <p class="hdng-txt2">Just Add 1 More Bottle of Restore CBD Gummies and Get 3 More FREE
That’s a Savings of Over <span>75% and our Lowest Price Ever!</span></p>
    </div>
    <div class="up-sec1">
        <p class="ups1-txt1"><img src="images/fls-img.png" class="fls-img"> Last Chance Saving Opportunity <img src="images/fls-img.png" class="fls-img"></p>
        <p class="ups1-txt2">Restore CBD Gummies<span><br>Pain Relief, Health & Wellness</span></p>
        <div class="up-blue-sec">
            <img src="images/downsell-1-prod.png" class="up1-s1-prod">   	
        </div>
        ...
        <div class="up-prcBox">
            <div class="prcDv prcDvline">
                <div class="rtl-prc">
                    ...
                    <div class="float-prc1">$414 <img src="images/red-line.png" class="up-redcut"></div>
                </div>
            </div>
            <div class="prcDv">
        ...
        <div class="btn-box">
            <a href="kon/process.php?page=upsell&step=dn1" class="packageBtn pulse getEmail">
                <p>Yes! Add To My Order! <img src="images/btn-arw.png" alt="" class="btn-arw"></p>
            </a>
        </div>
        <div class="clearall"></div>
    	</div>
