...
<div class="container"> 
	...
	<div class="up-top-hdng">
        <p class="hdng-txt1 up2-hdng-txt1"><span>Wait! How About All 4 For Just $24.75/ea? </span></p>
        <p class="hdng-txt2">Add 2 Bottles of Ashwagandha Gummies <br>& <span>Get 2 Bottles Free!</span></p>
    </div>
    <div class="up-sec1">
        ...
        <div class="up-prcBox">
            <div class="prcDv prcDvline">
                <div class="rtl-prc">
                    ...
                    <div class="float-prc1">$276 <img src="images/red-line.png" class="up-redcut"></div>
                </div>
            </div>
            <div class="prcDv">
                <div class="rtl-prc ofr-prc">
                    <p class="prc-txt">Offer Price:</p>
                    <div class="float-prc1">$24.75<small>/ea</small></div>
                </div>
            </div>
        </div>
    ...
    <div class="clearall"></div>
    <a href="downsell-3.php" class="no-thank"><img src="images/no-thnx.png"> No thanks, I don't want to get better results & save money!</a>
    <div class="clearall"></div>
