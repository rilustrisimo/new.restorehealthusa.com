...
<div class="container"> 
    ...
    <div class="up-sec1">
        ...
        <p class="ups1-txt2">Buy 1, Get 2 Free<span><br>For Just $16.33 Each</span></p>
        
        <div class="up-blue-sec">
            <img src="images/downsell-3-prod.png" class="up1-s1-prod"> 
        </div>
        ...
        <div class="up-prcBox">
            <div class="prcDv prcDvline">
                <div class="rtl-prc">
                    ...
                    <div class="float-prc1">$296 <img src="images/red-line.png" class="up-redcut"></div>
                </div>
            </div>
            <div class="prcDv">
        ...
        <p class="up-tot-prc">Total Price: $49</p>
