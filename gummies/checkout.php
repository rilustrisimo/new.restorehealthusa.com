                ...
                <div class="packBoxOuter pkg2" id="packageTwo">
                    ...
                    <div class="packagecontent">
                        <div class="p-box">
                            ...
                            <div class="pluse-icon">+</div>
                            <div class="chk-ofr-seal">Save<br><span class="saveOpt3">$60</span></div>
                        </div>
                        <div class="packRgt">
                            <div class="prc-bx">
                                <p class="list-prc">Regular Price : <span class="strikeout regularprice3"></span></p>
                                <p class="reglr-prc eachprice3">$49.97</p>
                                <p class="perbtl">per bottle</p>
                                <div class="pack-btn">Select</div>
                                <p class="free-ship-text"><img src="images/ship-ico.png"><strong>Free Shipping</strong></p>
                                <p class="totalPrc">Total: <span class="totalprice3">$149.91</span></p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="packagecontent">
                        ...
                        <div class="packRgt">
                            <div class="prc-bx">
                                ...
                                <p class="reglr-prc eachprice1">$69.99</p>
                                <p class="perbtl">per bottle</p>
                                <div class="pack-btn">Select</div>
                                <p class="free-ship-text"><img src="images/ship-ico.png"><strong>Free Shipping</strong></p>
                                <p class="totalPrc">Total: <span class="totalprice1" data-total="69.99">$69.99</span></p>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="exit-pop" style="display:none;">
	...
	<div class="exit-box">
    	<a href="checkout-10-off.php"><img src="images/popup1.jpg" class="popImg"></a>
    </div>
</div>
...
var totalPrice5 = 198.70;

var regularPrice3 = 209.97;
var totalPrice3 = 149.91;

var regularPrice1 = 69.99;
var totalPrice1 = 69.99;
