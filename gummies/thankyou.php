...
$kon->prepareData(array($_SESSION['orderId']));
...
<div class="header">
	<div class="container">
        ...
        <img src="images/ty-stp.png" class="chk-stp">
			...
			<div class="ty-coupn-inner">
            	...
            	<div class="summry-container">
                    ...
                    <div class="thnk-odrnmbr">
                        <p class="thnk-odrtxt1">Order Number: <span><?php echo $_SESSION['orderId']; ?></span></p>
                        <p class="thnk-odrtxt2">Order Date : <span><script type="text/javascript">getDate(0);</script></span></p>
                    </div>
                    
                    <div class="ty-odr-smryBox">
                        <div class="ty-heading-row">
                            <div class="ty-col-1">Product</div>
                            <div class="ty-col-3">Qty.</div>
                            <div class="ty-col-4">Price</div>
                        </div>
                        <?php foreach($order->items as $i): ?>
                        <div class="ty-prod-row">
                            <div class="ty-col-1">
                                <span class="ty-prodbx"><img src="images/<?php echo (in_array($i->productId, $cbd_ids))?'pack-prod1.png':'up-prod.png'; ?>"></span>
                                <p class="ty-prd-name"><?php echo $i->name; ?></p>
                            </div>
                            <div class="ty-col-3"><?php echo $i->productQty; ?></div>
...
<div class="footer">
	<div class="container">
        <p class="ftr-txt"><a href="#" data-fancybox data-src="#terms">Terms and Conditions</a>  |  <a href="#" data-fancybox data-src="#privacy">Privacy Policy</a>  |  <a href="#" data-fancybox data-src="#contact">Contact Us</a></p>
        <p class="ftr-txt"> &copy; <script type="text/javascript">var year = new Date();document.write(year.getFullYear());</script> Restore CBD Gummies. All Rights Reserved. </p>
    </div>
</div>
