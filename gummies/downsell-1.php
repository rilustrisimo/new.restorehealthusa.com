...
<div class="up-top-hdng">
    <div class="container">
        <p class="up-hdng-txt1"><img src="images/left-arw.png" class="left-arw tadda"> <span>Fair Enough.. But We Are Not Giving Up Yet!   </span> <img src="images/rgt-arw.png" class="rgt-arw taddaR"></p>
        <p class="up-hdng-txt2">Just Add 1 More Bottle of Restore CBD Gummies and Get 3 More FREE<br>That’s a Savings of Over <span>75% and  our Lowest Price Ever!</span></p>
    </div>
</div>
...
<div class="up-sec1">
	<div class="container">
    	<div class="up-s1-Box">
        	<div class="up-s1-lft">
            	<p class="ups1-txt1"><img src="images/fls-img.png" class="fls-img"> Last Chance Savings Opportunity <img src="images/fls-img.png" class="fls-img"></p>
                <p class="ups1-txt2" style="color:#f26522;">Restore CBD Gummies  <br><span>Pain Relief, Health & Wellness</span></p>
                
                
                <ul class="up-s1-list">
                	<li>Last Chance to Reserve Your Supply</li>
                    <li>Lowest Price Guarantee</li> 
                    <li>Biggest Discount We Can Offer</li>  
                </ul>
                ...
                <div class="up-prcBox" style="margin-top: 25px;">
                ...
                <div class="clearall"></div>
				<div class="btn-box">
                    <a href="kon/process.php?page=upsell&step=dn1" class="packageBtn pulse getEmail">
            ...
            <div class="up-s1-rght" style="background:#eef8ff;padding: 12px 10px;">
            	<img src="images/up1-prod1.png" class="up1-s1-prod">
                <p class="buy-txt">Buy 1<br> <img src="images/up-plus.png"> <br>Get 3 Free</p>
                <img src="images/up1-prod3-free.png" class="up1-s1-prod">
            </div>
            
        </div>
        <div class="clearall"></div>
        <a href="upsell-2.php" class="no-thank"><img src="images/no-thnx.png"> No thanks, I don't want to get better results & save money!  </a>
    </div>
</div>
