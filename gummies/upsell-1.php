...
<div class="up-top-hdng">
    <div class="container">
        <p class="up-hdng-txt1"><img src="images/left-arw.png" class="left-arw tadda"> <span>Wait! Buy 2 More & Get 4 Free!</span> <img src="images/rgt-arw.png" class="rgt-arw taddaR"></p>
        <p class="up-hdng-txt2">Don’t Run Out! Add 2 More Bottles of Restore CBD Gummies <br>to your order and <span>Get 4 More FREE!  – Today Only.</span></p>
    </div>
</div>
...
<div class="up-sec1">
	<div class="container">
    	<div class="up-s1-Box">
        	<div class="up-s1-lft">
            	<p class="ups1-txt1"><img src="images/fls-img.png" class="fls-img"> Our Lowest Price Guarantee <img src="images/fls-img.png" class="fls-img"></p>
                <p class="ups1-txt2" style="color:#f26522;">Restore CBD Gummies  <br><span>Pain Relief, Health & Wellness</span></p>
                
                
                <ul class="up-s1-list">
                	<li>Ensure Continued Use</li>
                    <li>Never Run Out in Uncertain Times</li> 
                    <li>Protection From Future Price Increases</li>  
                </ul>
                ...
                <div class="up-prcBox">
                    <div class="prcDv prcDvline">
                        <div class="rtl-prc">
                            ...
                            <div class="float-prc1">$414 <img src="images/up-red-line.png" class="up-redcut"></div>
                        </div>
                    </div>
                    <div class="prcDv">
                        <div class="rtl-prc ofr-prc">
                        	<p class="prc-txt">Offer Price:</p>
                            <div class="float-prc1">$23<small>/ea</small></div>
                        </div>
                    </div>
               	</div>
                ...
                <div class="clearall"></div>
				<div class="btn-box">
                    <a href="kon/process.php?page=upsell&step=up1" class="packageBtn pulse getEmail">
            ...
            <div class="up-s1-rght" style="background:#eef8ff;">
            	<img src="images/up1-prod2.png" class="up1-s1-prod">
                <p class="buy-txt">Buy 2<br> <img src="images/up-plus.png"> <br>Get 4 Free</p>
                <img src="images/up1-prod2-free.png" class="up1-s1-prod">
            </div>
            
        </div>
        <div class="clearall"></div>
        <a href="downsell-1.php" class="no-thank"><img src="images/no-thnx.png"> No thanks, I don't want to get better results & save money!  </a>
    </div>
</div>
